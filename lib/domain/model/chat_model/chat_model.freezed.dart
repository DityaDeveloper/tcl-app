...
abstract class $ChatModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String messageContent, String messageType});
}
...
class _$_ChatModel implements _ChatModel {
  const _$_ChatModel({this.messageContent = '', this.messageType = ''});
  ...
  @override
  String toString() {
    return 'ChatModel(messageContent: $messageContent, messageType: $messageType)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, messageContent, messageType);
...
abstract class _ChatModel implements ChatModel {
  const factory _ChatModel(
      {final String messageContent, final String messageType}) = _$_ChatModel;
